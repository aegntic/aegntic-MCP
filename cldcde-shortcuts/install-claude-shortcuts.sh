...
# This script installs the Claude CLI shortcuts into your shell configuration file (.bashrc)
...
cld-help() {
    cat "$HOME/cldcde-shortcuts/CLAUDE_CLI_SHORTCUTS.md"
}
EOF

# Apply changes
source "$CONFIG_FILE"
echo "Installation complete! Open a new terminal or source your .bashrc to use the shortcuts."
